        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-700 mb-12">
              Empathy Ledger isn&apos;t merely a platform—it&apos;s a paradigm shift in how we
              understand narrative power. We&apos;ve created the infrastructure for a continuously
              evolving ecosystem where:
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-purple-50 p-6 rounded-lg">
                ...
                <p className="text-gray-700">
                  Through narrative interaction, our understanding of what&apos;s possible
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-700">
                  Stories don&apos;t merely document reality—they actively reshape our understanding
                  of what&apos;s possible.
                </p>
              </div>
